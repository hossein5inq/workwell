...
Once fetched, this token needs to be included using the [setServiceToken](./docs/set-service-token.md)  method provided with the SDK so that it is included in all calls to the App.
